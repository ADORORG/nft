...
export default function SelectWithIcon(props: SelectWithIconInterface) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button 
                className={`flex-shrink-0 z-10 flex justify-between items-center py-2.5 px-4 text-sm font-semibold text-gray-500 bg-gray-100 border border-gray-300 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600 ${buttonClassName}`} 
                type="button"
            ...
            {
                isOpen &&
                <div className="absolute origin-top-left left-0 z-10 bg-white divide-y divide-gray-100 shadow dark:bg-gray-700">
