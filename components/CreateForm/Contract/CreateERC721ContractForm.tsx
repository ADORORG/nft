...
export default function CreateERC721ContractForm() {
    const router = useRouter()
    const { isConnected, address } = useAuthStatus()
    const [contractData, setContractData] = useState<Partial<ContractType>>({version: ERC721_VERSION, label: "", nftSchema: "erc721"})
    ...
    return (
        <div className="w-full md:w-1/2 lg:w-2/5 mx-auto">
            <h1 className="text-4xl pb-10 md:leading-4">Create ERC721 Contract</h1>
