...
export default function eventMintedOutEmailTemplate(mintEvent: PopulatedNftContractEventType) {
	...
	return `
		...
		<p style="margin: 0; word-break: break-word;"><span>
			${mintEvent.tokenName} minted out!
		</span></p>
		</div>
		</td>
		</tr>
		...
		<p style="margin: 0; word-break: break-word;"><span>
			Congratutions! ${mintEvent.tokenName} minted out. You can view it on ${name} marketplace.
		</span></p>
		</div>
		</td>
		</tr>
