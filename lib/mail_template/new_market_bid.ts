...
import { PopulatedMarketBidType } from '@/lib/types/bid'
import { AppInfo } from '../app.config'

export default function newMarketBidEmailTemplate(marketOrder: PopulatedMarketOrderType, marketBid: PopulatedMarketBidType) {
