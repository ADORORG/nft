...
abstract contract ERC2981 is IERC2981, ERC165 {
    ...
    uint96 public constant MAX_ROYALTY = 9900; // 99%
...
contract ERC721OpenEdition is ERC721Permit, Ownable {
    ...
    mapping(address _account => uint256 _purchaseCount) public userPurchases;
    ...
    constructor(
        ...
        ERC721Permit(name_, symbol_) {
            ...
            setConfiguration(initConfig_);
    }

    function setConfiguration(Configuration memory newConfig_) public onlyOwner {
        editionConfig = newConfig_;
        _setDefaultRoyalty(newConfig_.royaltyReceiver, newConfig_.royalty);
    }
    ...
    function mint(address to_) public payable returns (uint256) {
        ...
        require(
            ...
            ||
            userPurchases[to_] < editionConfig.maxMintPerWallet, 
    ...
    function batchMint(address to, uint256 amount) public payable {
        ...
        require(
            editionConfig.maxMintPerWallet == 0
            ||
            userPurchases[to] + amount <= editionConfig.maxMintPerWallet, 
            "Maximum purchase per wallet reached"
        );
