 ...
 * _Available since v3.1._
 */
contract ERC1155 is Context, ERC165, ERC2981, IERC1155, IERC1155MetadataURI {
...
contract NFT1155 is ERC1155, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, string memory _baseURI, uint96 defaultRoyalty_) {
    string memory baseURI = string(abi.encodePacked(_baseURI, (address(this)).toHexString(), "/"));
    _setURI(baseURI);
  ...
  /**
    ...
    */
  function create(address _initialOwner, uint256 _initialSupply, bytes calldata _data) external onlyOwner returns (uint256) {
    _tokenIds.increment();
